  ...
  return (
    <section style={{ padding: "7rem 2rem" }}>
      <div style={{ maxWidth: "68rem", margin: "0 auto" }}>
        <SectionHeader label="Objectif" title="Stage" />
...
>
  Actuellement en BUT Informatique, je recherche un{" "}
  <strong style={{ fontWeight: 600, color: "#0D0D0D" }}>
    stage de 8 à 12 semaines
  </strong>{" "}
  en{" "}
  <strong style={{ fontWeight: 600, color: "#0D0D0D" }}>
    développement logiciel
  </strong>{" "}
  dans le cadre de mon parcours RAPP. Si le stage se passe bien, je serais également intéressé par une{" "}
  <strong style={{ fontWeight: 600, color: "#0D0D0D" }}>
    alternance ou un stage en 3ème année
  </strong>.
</p>
          ...
          <FadeUp delay={160}>
            <div style={{ display: "flex", flexDirection: "column", gap: "0.625rem", minWidth: "14rem" }}>
              <InfoCard label="Durée recherchée" value="8 à 12 semaines" />
